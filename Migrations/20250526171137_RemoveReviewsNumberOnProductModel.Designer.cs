...
namespace eApp.Migrations
{
    ...
    [Migration("20250526171137_RemoveReviewsNumberOnProductModel")]
    partial class RemoveReviewsNumberOnProductModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eApp.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eApp.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eApp.Models.Address", b =>
                {
                    b.HasOne("eApp.Models.User", "User")
                        .WithOne("Address")
                        .HasForeignKey("eApp.Models.Address", "UserId")
            ...
            modelBuilder.Entity("eApp.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("eApp.Models.Product", "Product")
                        .WithMany("CartItems")
